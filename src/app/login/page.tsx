    ...
    try {
      ...
      switch (mode) {
        ...
        case MODE.RESET_PASSWORD:
          ...
          setMessage("Password reset email sent. Please check you e-mail");
          break;
  ...
  return (
    <div className="h-[calc(100vh-80px)] px-4 md:px-8 lg-px-16 xl:px-32 2xl:px-64 flex items-center justify-center">
      <form className="flex flex-col gap-8" onSubmit={handleSubmit}>
        ...
        <button
          className="bg-light-orange text-white p-2 rounded-md disabled:bg-pink-200 disabled:cursor-not-allowed"
          disabled={isLoading}
        >
