...
const CustomizeProducts = ({
  ...
  return (
    <div className="flex flex-col gap-6">
          ...
          <ul className="flex items-center gap-3">
            {option.choices?.map((choice, index) => {
              ...
              return option.name === "Color" ? (
                ...
                <li
                  className="ring-1 ring-light-orange text-light-orange rounded-md py-1 px-4 text-sm"
                  style={{
                    cursor: disabled ? "not-allowed" : "pointer",
      ...
      <ul className="flex items-center gap-3">
        <li className="ring-1 ring-light-orange text-light-orange rounded-md py-1 px-4 text-sm cursor-pointer">
          Small
        </li>
        <li className="ring-1 ring-light-orange text-white bg-light-orange rounded-md py-1 px-4 text-sm cursor-pointer">
          Medium
        </li>
